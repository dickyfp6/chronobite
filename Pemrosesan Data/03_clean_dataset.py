...
haram_keywords = [
    "ABITA", "ABSINTHE", "ADOBO", "ADVOCAT", "AIDELLS", "AJENJO", "ALCHOHOL", "ALCHOLIC", 
    "ALCOHAL", "ALCOHIC", "ALCOHOL", "ALCOHOLIC", "ALE", "ALMDUDLER", "AMARETTO", "AMBERYE", 
    "AMERETTO", "AMERICANO", "AMOORETTO", "ANDOUILIE", "ANDOUILLE", "ANDOVILLE", "ANISETTE", 
    "APERITIF", "APERITIVO", "APPLEGATE", "APPLETINI", "ARABIKI", "ARMAGNAC", "ARMOUR", 
    "ASAHI", "BABYBACK", "BACARDI", "BACCHUS", "BACKFAT", "BACN", "BACOM", "BACON", 
    ...
    "CARIGNANE", "CARNE", "CARNITA", "CARNITAS", "CAVA", "CELLARS", "CERDO", 
    ...
    "CHORIZOS", "CHOURICO", "CIDAR", "CIDER", "CIDERMATE", "CIDERS", "CITTERIO", 
    ...
    "CURRYWURST", "CUTLET", "CUVEE", "DAIGUIRI", "DAIQUIRI", "DELICATESSEN", 
    ...
    "GOSMOPOLITAN", "GRASOVKA", "GRAVY", "GRENACHE", "GRIGIO", "GROG", "GUANCIALE", 
    ...
    "LIQUEUR", "LIQUEURS", "LIQUOR", "LIVER", "LIVERWURST", "LOIN", "LONGANISA", 
    "LONGANIZA", "LUCANO", "LUGANIGA", "LUNCHEON", "MALT", "MALTS", "MANAPUA", 
    "MANHATTAN", "MANISCHEWITZ", "MARASCHINO", "MARGARITA", "MARINATED", "MARSALA", 
    "MARSHMALLOW", "MARZEN", "MEAD", "MEAT", "MENAGE", "MERLOT", "METTWURST", 
    ...
    "RIBNOXIOUS", "RIESLING", "RIOJA", "ROSSI", "ROTISSERIE", "RUM", "SAHSAGE", 
    "SAISAGE", "SAKE", "SALAME", "SALAMETTI", "SALAMI", "SALAMINI", "SALAMIS", 
    "SALCHICHON", "SALCHION", "SALUMERIA", "SAMBUCA", "SANGARIA", "SANGIOVESE", 
    "SARONNO", "SAUAGE", "SAUCISSE", "SAUCISSON", "SAUSAGE", "SAUSGAE", "SAUTERNE", 
    ...
    "SHOULDER", "SHUMAI", "SIDEMEAT", "SIDRA", "SIRAH", "SKAL", "SKOL", "SLOE", 
