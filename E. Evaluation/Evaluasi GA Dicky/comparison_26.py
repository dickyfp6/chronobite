...
greedy_csv = os.path.join(current_dir, 'output', 'greedy_26', 'summary.csv')
ga_csv = os.path.join(current_dir, 'output', 'ga_26', 'summary.csv')
...
def main():
    print("==========================================")
    print(" COMPARING GREEDY VS GENETIC ALGORITHM (26 CASES) ")
    print("==========================================")
    ...
    ax.set_xticks(x)
    ax.set_xticklabels(merged['Profile'], rotation=45, ha='right')
    ax.legend()
    ax.set_ylim(0, 110)
