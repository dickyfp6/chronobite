"""
File Analisis: Kelengkapan Nutrisi (HC & SC)
Tujuan: Mengecek persentase ketersediaan data (tidak NULL/0) untuk masing-masing atribut nutrisi wajib (HC)
maupun pendukung (SC) pada dataset akhir (04_super_final.csv).
Ini berguna untuk mengevaluasi kualitas data dari segi kekosongan nilai gizi.
"""
