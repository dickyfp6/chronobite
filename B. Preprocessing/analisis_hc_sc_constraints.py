"""
File Analisis: Distribusi Hard Constraint & Soft Constraint
Tujuan: Menganalisis berapa jumlah nutrisi HC dan SC yang terisi per makanan pada tahap setelah pembersihan (02_cleaned_dataset.csv).
Hasil dari script ini akan disimpan di 04_hc_sc_analysis.csv untuk keperluan dokumentasi statistik sebelum filter HC/SC diterapkan.
"""
...
INPUT_FILE = os.path.normpath(os.path.join(CURRENT_DIR, "..", "A. Data", "Data Processed", "02_cleaned_dataset.csv"))
...
OUTPUT_FILE = os.path.normpath(os.path.join(CURRENT_DIR, "..", "A. Data", "Data Processed", "04_hc_sc_analysis.csv"))
