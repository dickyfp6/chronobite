...
const mealThemes = {
  breakfast: {
    title: 'Breakfast',
    time: '07:00 - 09:00',
    themeClass: "bg-gradient-to-br from-amber-100/35 via-amber-50/15 to-orange-100/25 dark:from-amber-950/20 dark:via-slate-900/70 dark:to-orange-950/15",
    borderClass: "border border-amber-200/60 dark:border-amber-900/40",
    tagBg: "bg-amber-100/90 text-amber-800 dark:bg-amber-950/50 dark:text-amber-300 border border-amber-200/30",
    ...
    cardClass: "border border-amber-300/40 dark:border-amber-900/40 bg-gradient-to-br from-amber-200/40 via-amber-100/20 to-orange-100/30 dark:from-amber-950/40 dark:via-slate-900/70 dark:to-orange-950/30 shadow-[0_4px_12px_rgba(0,0,0,0.02)]"
  },
  lunch: {
    title: 'Lunch',
    time: '12:00 - 14:00',
    themeClass: "bg-gradient-to-br from-sky-100/30 via-sky-50/15 to-yellow-100/35 dark:from-sky-950/20 dark:via-slate-900/70 dark:to-yellow-950/25",
    borderClass: "border border-sky-200/60 dark:border-sky-900/40",
    tagBg: "bg-sky-100/90 text-sky-800 dark:bg-sky-950/50 dark:text-sky-300 border border-sky-200/30",
    ...
    cardClass: "border border-sky-300/40 dark:border-sky-900/40 bg-gradient-to-br from-sky-200/40 to-yellow-250/30 dark:from-sky-900/30 dark:to-yellow-950/40 shadow-[0_4px_12px_rgba(0,0,0,0.02)]"
  },
  dinner: {
    title: 'Dinner',
    time: '18:00 - 19:00',
    themeClass: "bg-gradient-to-br from-indigo-100/35 via-indigo-50/15 to-purple-100/30 dark:from-indigo-950/20 dark:via-slate-900/70 dark:to-purple-950/15",
    borderClass: "border border-indigo-200/60 dark:border-indigo-900/40",
    tagBg: "bg-indigo-100/90 text-indigo-800 dark:bg-indigo-950/50 dark:text-indigo-300 border border-indigo-200/30",
    ...
    cardClass: "border border-indigo-300/40 dark:border-indigo-900/40 bg-gradient-to-br from-indigo-200/40 to-blue-900/20 dark:from-indigo-950/35 dark:to-blue-950/45 shadow-[0_4px_12px_rgba(0,0,0,0.02)]"
  },
  snack: {
    title: 'Snack',
    time: '15:00 - 16:00',
    themeClass: "bg-gradient-to-br from-rose-100/35 via-rose-50/15 to-pink-100/30 dark:from-rose-950/20 dark:via-slate-900/70 dark:to-pink-950/15",
    borderClass: "border border-rose-200/60 dark:border-rose-900/40",
    tagBg: "bg-rose-100/90 text-rose-800 dark:bg-rose-950/50 dark:text-rose-300 border border-rose-200/30",
    ...
    cardClass: "border border-rose-300/40 dark:border-rose-900/40 bg-gradient-to-br from-rose-200/40 via-rose-100 to-pink-100/30 dark:from-rose-950/40 dark:via-slate-900/70 dark:to-pink-950/30 shadow-[0_4px_12px_rgba(0,0,0,0.02)]"
  }
};
  ...
  return (
    <div className="w-full font-sans">
        ...
        >
          ...
          {activeTab === 0 && (
            <div>
              <div className="flex flex-col md:flex-row md:items-center justify-between pb-6 border-b border-border dark:border-slate-800 gap-6 mb-8">
                <div>
                  <h2 className="text-2xl font-bold text-gray-900 dark:text-white font-serif tracking-tight">{t.report.tabs.menu}</h2>
                  <p className="text-sm text-gray-500 dark:text-gray-400 font-sans mt-0.5">Overview of your generated daily meal plan</p>
                </div>
              </div>
              ...
              <div className="space-y-8">
                {Object.entries(mealThemes).map(([mealKey, theme]) => {
                  ...
                  if (mealKey === 'snack') {
                    return (
                      <div key={mealKey} className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
                        ...
                        <div 
                          className={`md:col-span-1 relative overflow-hidden rounded-3xl p-6 sm:p-7 ${theme.borderClass} ${theme.themeClass} shadow-xl dark:shadow-none transition-all duration-300`}
                        >
                          ...
                          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4 relative z-10">
                            <div className="flex items-center gap-3">
                              <div>
                                <h3 className="text-lg font-bold text-gray-955 dark:text-white font-serif leading-none mb-1.5 capitalize">
                                  {theme.title}
                                </h3>
                          ...
                          <div className="grid grid-cols-1 gap-4 relative z-10">
                            {items.map((item, i) => {
                              ...
                              const tagColorClass = 'bg-white/40 text-gray-800 dark:bg-slate-900/60 dark:text-slate-200 border border-black/5 dark:border-white/5';
                                ...
                                >
                                  <div className="mb-3">
                                    <div className="flex items-center justify-between gap-2 mb-2">
                                      ...
                                      <span className="text-[10px] text-gray-600 dark:text-gray-350 font-medium font-serif">{item.portion}</span>
                                    </div>
                                    <h4 className="font-sans font-bold text-gray-900 dark:text-white text-[14px] leading-snug line-clamp-2">
                                      {item.item}
                                    </h4>
                                  </div>
                                  ...
                                  <div className="mt-auto pt-3 border-t border-black/5 dark:border-white/10">
                                    ...
                                    <div className="flex items-center justify-between text-[10px] text-gray-700 dark:text-gray-300 font-sans">
                        ...
                        <div className="md:col-span-2 bg-gradient-to-br from-sky-100/35 via-sky-50/15 to-blue-100/30 dark:from-sky-950/20 dark:via-slate-900/70 dark:to-blue-950/15 border border-sky-200/60 dark:border-sky-900/40 rounded-3xl pt-6 pb-4 px-6 flex flex-col justify-between shadow-xl dark:shadow-none transition-all duration-300 relative overflow-hidden min-h-[200px]">
                          {/* Water glow circles */}
                          ...
                          <div className="relative z-10 flex gap-6 sm:gap-8 items-start justify-between h-full w-full">
                            ...
                            <div className="flex-1 flex flex-col justify-start min-w-0">
                              <div>
                                <h3 className="text-lg font-bold text-gray-955 dark:text-white font-serif leading-none mb-1.5 capitalize truncate">
                                  Hydration Tracker
                                </h3>
                                <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-[11px] font-bold bg-sky-100/90 text-sky-800 dark:bg-sky-950/50 dark:text-sky-300 border border-sky-200/30 shadow-sm bg-opacity-90">
                              ...
                              <div className="mt-5 space-y-5">
                                  {/* Secured Block */}
                                  <div className="space-y-1">
                                    <span className="text-[10px] font-bold text-sky-600/90 dark:text-sky-400/80 uppercase tracking-widest block">
                                      Secured From Meals
                                    </span>
                                    <div className="flex items-baseline gap-1">
                                      <span className="text-xl font-extrabold text-sky-600 dark:text-sky-400 font-serif leading-none">
                                        {foodWaterLiters.toFixed(2)}
                                      </span>
                                      <span className="text-xs font-bold text-sky-600/70 dark:text-sky-400/60">Liters</span>
                                    </div>
                                  ...
                                  {/* Needed Block */}
                                  <div className="space-y-1">
                                    <span className="text-[10px] font-bold text-amber-600/90 dark:text-amber-500/80 uppercase tracking-widest block">
                                      Additional Needed
                                    </span>
                                    <div className="flex items-baseline gap-1">
                                      <span className="text-3xl font-extrabold text-amber-500 dark:text-amber-450 font-serif leading-none">
                                        {Math.max(0, waterTargetLiters.min - foodWaterLiters).toFixed(2)}
                                      </span>
                                      <span className="text-base font-bold text-amber-500/70 dark:text-amber-450/60">Liters</span>
                                    </div>
                                    <p className="text-[11px] text-gray-500 dark:text-gray-400 font-medium">
                            ...
                            <div className="relative w-40 h-56 flex flex-col items-center justify-start shrink-0 pt-0 filter drop-shadow-[0_10px_20px_rgba(0,0,0,0.25)] dark:drop-shadow-[0_10px_20px_rgba(0,0,0,0.6)]">
                              {/* Glass Top Rim */}
                              <div className="absolute top-0 w-36 h-5 bg-sky-200/20 dark:bg-sky-850/10 border border-sky-350/50 dark:border-sky-700/50 rounded-full z-30 pointer-events-none" />
                              
                              {/* Thin Tapered Glass Border Outline */}
                              <svg 
                                viewBox="0 0 100 100" 
                                preserveAspectRatio="none" 
                                className="absolute top-[10px] w-36 h-52 text-sky-300/60 dark:text-sky-800/60 pointer-events-none z-20"
                              >
                                <polygon 
                              ...
                              {/* Tapered Glass Body */}
                              <div 
                                className="relative w-36 h-52 bg-sky-100/15 dark:bg-slate-950/20 border border-sky-300/20 dark:border-sky-800/20 rounded-b-2xl overflow-hidden shadow-inner flex items-center justify-center mt-2.5"
                              ...
                              >
                                ...
                                >
                                  ...
                                  <svg 
                                    viewBox="0 0 240 28" 
                                    preserveAspectRatio="none"
                                    className="absolute left-0 w-[200%] text-sky-300/40 dark:text-sky-400/30" 
                                  ...
                                  <svg 
                                    viewBox="0 0 240 28" 
                                    preserveAspectRatio="none"
                                    className="absolute left-0 w-[200%] text-sky-400/85 dark:text-sky-500/85" 
                                ...
                                <div className="relative z-20 flex flex-col items-center select-none pointer-events-none">
                                  <span className="font-extrabold text-[18px] text-sky-900 dark:text-sky-100 drop-shadow-sm font-sans leading-none bg-white/40 dark:bg-slate-950/40 px-2 py-1 rounded-lg border border-sky-200/10 backdrop-blur-xs">
                  ...
                  return (
                    <div 
                      key={mealKey} 
                      className={`relative overflow-hidden rounded-3xl p-6 sm:p-7 ${theme.borderClass} ${theme.themeClass} shadow-xl dark:shadow-none transition-all duration-300`}
                    >
                      {/* Sun/Sunset art glow effects */}
                      <div className={theme.glowClass} />
                      <div className={theme.glowClass2} />
                ...
                return (
                  <div className="mt-10 space-y-5">
                    ...
                    {excessiveWarnings.length > 0 && (
                      <div className="p-6 rounded-2xl border bg-red-500/5 dark:bg-red-550/10 border-red-500/15 dark:border-red-500/10 shadow-sm font-sans animate-fade-in">
                        <div className="flex items-center gap-2.5 mb-3">
                          <span className="text-red-500 text-lg font-bold">⚠️</span>
                          <h3 className="font-bold text-sm text-red-950 dark:text-red-350 font-serif">
                            Nutritional Excess Alerts
                          </h3>
                        </div>
                        <p className="text-xs text-gray-650 dark:text-gray-400 mb-4 font-sans leading-relaxed">
                        ...
                        <ul className="space-y-2.5">
                          {excessiveWarnings.map((warning, index) => (
                            <li key={index} className="flex items-start gap-2.5 text-xs text-red-900 dark:text-red-400 font-medium font-sans">
                    ...
                    {deficientWarnings.length > 0 && (
                      <div className="p-6 rounded-2xl border bg-amber-500/5 dark:bg-amber-550/10 border-amber-500/15 dark:border-amber-500/10 shadow-sm font-sans animate-fade-in">
                        <div className="flex items-center gap-2.5 mb-3">
                          <span className="text-amber-500 text-lg font-bold">⚠️</span>
                          <h3 className="font-bold text-sm text-amber-950 dark:text-amber-350 font-serif">
                        ...
                        <ul className="space-y-2.5">
                          {deficientWarnings.map((warning, index) => (
                            <li key={index} className="flex items-start gap-2.5 text-xs text-amber-900 dark:text-amber-400 font-medium font-sans">
            ...
            <div>
              ...
              {(() => {
                const getNutrientCardData = (nutrientKey: string) => {
                  ...
                  let showBadge = true;
                  let cardBg = 'bg-green-50/90 dark:bg-green-950/30 border-green-300 dark:border-green-900';
                  let badgeBg = 'bg-green-100 text-green-700 dark:bg-green-950/80 dark:text-green-400';
                  let textColor = 'text-green-700 dark:text-green-400';
                  let titleColor = 'text-green-900 dark:text-green-200';
                  let priority = 3;
                  ...
                  if (isDeficient) {
                    ...
                    showBadge = true;
                    priority = 1;
                    cardBg = 'bg-red-50/90 dark:bg-red-950/30 border-red-300 dark:border-red-900';
                    badgeBg = 'bg-red-100 text-red-700 dark:bg-red-950/80 dark:text-red-400';
                    ...
                    showBadge = true;
                    priority = 2;
                    cardBg = 'bg-amber-50/90 dark:bg-amber-950/30 border-amber-300 dark:border-amber-900';
                    badgeBg = 'bg-amber-100 text-amber-700 dark:bg-amber-950/80 dark:text-amber-400';
        ...
        {isPreviewModalOpen && previewUrl && (
          <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <motion.div
              ...
              className="bg-white dark:bg-slate-900 w-full max-w-2xl h-[85vh] rounded-3xl overflow-hidden shadow-2xl flex flex-col border border-slate-200 dark:border-slate-800"
            >
              {/* Header */}
              ...
              <div className="flex-1 bg-slate-100 dark:bg-slate-950 p-4 flex items-center justify-center">
                <iframe
                  src={previewUrl}
                  className="h-full aspect-[1/1.414] max-w-full rounded-2xl border border-slate-200/80 dark:border-slate-800/80 shadow-sm bg-white"
                  title="PDF Preview"
                />
              </div>
