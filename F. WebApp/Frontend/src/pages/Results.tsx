...
const mealThemes: Record<string, {
 ...
 badgeBg: "bg-amber-100/90 border border-amber-200/30",
 badgeText: "text-amber-800 ",
 borderColor: "hover:border-amber-450/50 :border-amber-500/50",
 selectedClass: "border-2 border-amber-450 bg-gradient-to-br from-amber-200 via-amber-100 to-orange-100 shadow-[0_10px_25px_rgba(0,0,0,0.1)] (0,0,0,0.4)] backdrop-blur-md scale-[1.02] transition-all duration-300",
 unselectedClass: "border border-white/50 bg-white/45 shadow-[0_4px_15px_rgba(0,0,0,0.03)] (0,0,0,0.12)] hover:bg-white/70 :bg-slate-900/40 hover:border-amber-300/50 :border-amber-500/30 hover:shadow-[0_8px_20px_rgba(0,0,0,0.06)] :shadow-[0_8px_20px_rgba(0,0,0,0.25)] hover:-translate-y-0.5 backdrop-blur-md transition-all duration-300"
 },
 lunch: {
 color: "sky",
 ...
 badgeBg: "bg-sky-100/90 border border-sky-200/30",
 badgeText: "text-sky-800 ",
 borderColor: "hover:border-sky-450/50 :border-sky-500/50",
 selectedClass: "border-2 border-sky-450 bg-gradient-to-br from-sky-200 to-yellow-200 shadow-[0_10px_25px_rgba(0,0,0,0.1)] (0,0,0,0.4)] backdrop-blur-md scale-[1.02] transition-all duration-300",
 unselectedClass: "border border-white/50 bg-white/45 shadow-[0_4px_15px_rgba(0,0,0,0.03)] (0,0,0,0.12)] hover:bg-white/70 :bg-slate-900/40 hover:border-sky-300/50 :border-sky-500/30 hover:shadow-[0_8px_20px_rgba(0,0,0,0.06)] :shadow-[0_8px_20px_rgba(0,0,0,0.25)] hover:-translate-y-0.5 backdrop-blur-md transition-all duration-300"
 },
 dinner: {
 color: "indigo",
 ...
 icon: (
 <svg className="w-8 h-8 text-indigo-500 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
 <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z" />
 </svg>
 ),
 badgeBg: "bg-indigo-100/90 border border-indigo-200/30",
 badgeText: "text-indigo-800 ",
 borderColor: "hover:border-indigo-450/50 :border-indigo-500/50",
 selectedClass: "border-2 border-indigo-450 bg-gradient-to-br from-indigo-200 to-blue-900/30 shadow-[0_10px_25px_rgba(0,0,0,0.1)] (0,0,0,0.4)] backdrop-blur-md scale-[1.02] transition-all duration-300",
 unselectedClass: "border border-white/50 bg-white/45 shadow-[0_4px_15px_rgba(0,0,0,0.03)] (0,0,0,0.12)] hover:bg-white/70 :bg-slate-900/40 hover:border-indigo-300/50 :border-indigo-500/30 hover:shadow-[0_8px_20px_rgba(0,0,0,0.06)] :shadow-[0_8px_20px_rgba(0,0,0,0.25)] hover:-translate-y-0.5 backdrop-blur-md transition-all duration-300"
 },
 snack: {
 color: "rose",
 ...
 badgeBg: "bg-rose-100/90 border border-rose-200/30",
 badgeText: "text-rose-800 ",
 borderColor: "hover:border-rose-450/50 :border-rose-500/50",
 selectedClass: "border-2 border-rose-450 bg-gradient-to-br from-rose-200 via-rose-100 to-pink-100 shadow-[0_10px_25px_rgba(0,0,0,0.1)] (0,0,0,0.4)] backdrop-blur-md scale-[1.02] transition-all duration-300",
 unselectedClass: "border border-white/50 bg-white/45 shadow-[0_4px_15px_rgba(0,0,0,0.03)] (0,0,0,0.12)] hover:bg-white/70 :bg-slate-900/40 hover:border-rose-300/50 :border-rose-500/30 hover:shadow-[0_8px_20px_rgba(0,0,0,0.06)] :shadow-[0_8px_20px_rgba(0,0,0,0.25)] hover:-translate-y-0.5 backdrop-blur-md transition-all duration-300"
 }
};
...
export function Results({ userData, algorithm, analysisResult, menuPromise, onViewReport, selectedItems, onSelectedItemsChange }: ResultsProps) {
 ...
 className="w-1.5 h-6 bg-emerald-500/20 rounded-full filter blur-[1px]"
 />
 ))}
 </div>
 ...
 <div className="absolute inset-x-0 bottom-0 h-16 bg-slate-100 z-0" />
 ...
 <div className="w-full h-full rounded-b-[48px] border-4 border-t-0 border-emerald-600 bg-gradient-to-b from-white/50 to-slate-100/60 backdrop-blur-[3px] shadow-lg z-20" />
 </div>
 </motion.div>
 ...
 className="w-28 h-2 bg-black/10 rounded-full filter blur-[2.5px] mb-8"
 />
 </div>
 ...
 className="text-gray-700 font-semibold text-lg font-sans tracking-wide"
 >
 {currentStepText}
 </motion.p>
 </AnimatePresence>
 ...
 <p className="text-xs text-gray-500 font-medium font-sans mt-2">
 ...
 <div className="bg-white/70 backdrop-blur-md p-8 rounded-3xl border border-destructive/30 max-w-lg text-center shadow-xl shadow-primary/5 ">
 ...
 return (
 <div key={mealName} className={`relative overflow-hidden backdrop-blur-md rounded-3xl p-6 border shadow-xl transition-all duration-300 ${theme.containerBg} ${theme.containerBorder}`}>
 {/* Sun/Sunset art glow effects */}
 <div className={theme.glowClass} />
 <div className={theme.glowClass2} />

 <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6 border-b border-border/50 pb-4 relative z-10">
 <div className="flex items-center gap-3">
 <div className="p-2.5 bg-white/80 rounded-2xl shadow-sm border border-border/40">
 {theme.icon}
 </div>
 <div>
 <h2 className="text-xl font-bold text-gray-900 capitalize font-serif leading-none mb-1.5 flex items-center gap-2">
 {mealName}
 </h2>
 ...
 <div key={courseName}>
 <div className="mb-3">
 <h3 className="font-serif font-semibold text-gray-950 capitalize text-sm tracking-wide">
 ...
 <p className="text-xs text-gray-500 font-sans">No foods found matching your constraints.</p>
 </div>
 ) : (
 ...
 <p className="font-bold text-sm text-gray-900 leading-snug line-clamp-2 flex-1 font-sans">
 {displayOption.name}
 </p>
 ...
 <div className="flex items-center justify-between text-[10px] text-gray-500 font-sans">
 ...
 <h3 className="font-serif font-semibold text-gray-950 text-sm tracking-wide">Options</h3>
 </div>

 {!menuData.snack.candidates || menuData.snack.candidates.length === 0 ? (
 <div className="p-4 rounded-2xl border border-dashed border-border bg-secondary/20 text-center relative z-10">
 <p className="text-xs text-gray-500 font-sans">No snack found matching your constraints.</p>
 </div>
 ) : (
