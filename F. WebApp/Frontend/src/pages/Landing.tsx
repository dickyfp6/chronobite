    ...
    >
      <div className="flex-1 flex items-center justify-center py-6 md:py-12 px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-6xl relative">
              ...
              <div className="flex-1 flex flex-col justify-center">
                <AnimatePresence mode="wait">
                  <motion.div
                    ...
                    className="space-y-4"
                  >
                    <span className="inline-flex items-center gap-1.5 px-3.5 py-1.5 bg-primary/10 dark:bg-primary/20 text-primary dark:text-emerald-400 rounded-full text-xs font-bold uppercase tracking-wider font-sans border border-primary/20">
                      {slide.badge}
                    </span>
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    <div className="w-full h-full rounded-[32px] overflow-hidden shadow-2xl relative">
                      ...
                      <div className="absolute bottom-4 left-4 right-4 bg-white/90 dark:bg-slate-900/90 backdrop-blur-md p-4 rounded-2xl border border-border/80 dark:border-slate-800 shadow-lg">
                        ...
                        <div className="w-full bg-secondary dark:bg-slate-800 h-2 rounded-full overflow-hidden">
                          <div
                            className="bg-primary dark:bg-emerald-400 h-full rounded-full transition-all duration-500"
                    ...
                    <div className="absolute -top-6 -right-2 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md py-3 px-4 rounded-2xl border border-border/80 dark:border-slate-850 shadow-xl flex items-center gap-3">
                      <div className="w-9 h-9 rounded-xl bg-primary/10 text-primary dark:bg-primary/20 dark:text-emerald-450 flex items-center justify-center">
                        <WidgetIcon className="w-4 h-4" />
                      </div>
                      <div className="text-left font-sans">
                        <span className="block text-[8px] font-bold text-gray-500 dark:text-gray-400 tracking-wider uppercase leading-none mb-0.5">
          ...
          <button
            onClick={prevSlide}
            className="absolute left-[-20px] md:left-[-60px] top-1/2 -translate-y-1/2 p-2.5 bg-white/90 dark:bg-slate-800/95 border border-border/85 dark:border-slate-800 rounded-full hover:bg-primary hover:text-white transition-all shadow-md backdrop-blur-sm cursor-pointer z-20 hidden md:block"
          ...
          <button
            onClick={nextSlide}
            className="absolute right-[-20px] md:right-[-60px] top-1/2 -translate-y-1/2 p-2.5 bg-white/90 dark:bg-slate-800/95 border border-border/85 dark:border-slate-800 rounded-full hover:bg-primary hover:text-white transition-all shadow-md backdrop-blur-sm cursor-pointer z-20 hidden md:block"
